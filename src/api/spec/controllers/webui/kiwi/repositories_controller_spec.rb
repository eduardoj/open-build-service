...
RSpec.describe Webui::Kiwi::RepositoriesController, type: :controller, vcr: true do
  ...
  let(:package) { create(:package_with_kiwi_file, name: 'fake_package', project: project, kiwi_image_id: kiwi_image.id) }
  ...
  describe 'GET #index' do
    subject { get :index, params: { kiwi_image_id: package.kiwi_image_id } }
  ...
  describe 'GET #edit' do
    subject { get :edit, params: { kiwi_image_id: package.kiwi_image_id } }
  ...
  describe 'POST #update' do
    context 'with invalid repositories data' do
      subject { post :update, params: { kiwi_image_id: package.kiwi_image_id } }
    ...
    context 'with valid repositories data' do
      ...
      let(:update_params) do
        {
          kiwi_image_id: package.kiwi_image_id,
